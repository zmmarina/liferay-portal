 ...
 */
public class SamlSpSessionUpgradeProcess2 extends UpgradeProcess {
	...
	protected void doUpgrade() throws Exception {
		try (LoggingTimer loggingTimer = new LoggingTimer()) {
			alter(
				...
				new AlterTableDropColumn("samlIdpEntityId"),
				new AlterTableDropColumn("nameIdFormat"),
				new AlterTableDropColumn("nameIdNameQualifier"),
				new AlterTableDropColumn("nameIdSPNameQualifier"),
