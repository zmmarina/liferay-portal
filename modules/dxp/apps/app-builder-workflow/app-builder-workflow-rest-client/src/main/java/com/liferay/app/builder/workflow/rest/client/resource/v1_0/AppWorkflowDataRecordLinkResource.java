...
public interface AppWorkflowDataRecordLinkResource {
	...
	public HttpInvoker.HttpResponse
			postAppAppWorkflowDataRecordLinksPageHttpResponse(
				Long appId, DataRecordIds dataRecordIds)
		throws Exception;
	...
	public static class AppWorkflowDataRecordLinkResourceImpl
		implements AppWorkflowDataRecordLinkResource {
		...
		public Page<AppWorkflowDataRecordLink>
			...
			try {
				return Page.of(content, AppWorkflowDataRecordLinkSerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.body(dataRecordIds.toString(), "application/json");
		...
		private AppWorkflowDataRecordLinkResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			AppWorkflowDataRecordLinkResource.class.getName());
