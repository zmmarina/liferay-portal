...
public abstract class CommerceApplicationModelServiceBaseImpl
	...
	implements CommerceApplicationModelService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CommerceApplicationModelService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>CommerceApplicationModelServiceUtil</code>.
	 */
	 ...
	 */
	public CommerceApplicationModelService
	...
	public void afterPropertiesSet() {
		_setServiceUtilService(commerceApplicationModelService);
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				CommerceApplicationModelServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, commerceApplicationModelService);
		}
	...
	@BeanReference(
		type = com.liferay.commerce.application.service.CommerceApplicationModelCProductRelService.class
	)
	protected com.liferay.commerce.application.service.
		CommerceApplicationModelCProductRelService
			commerceApplicationModelCProductRelService;
