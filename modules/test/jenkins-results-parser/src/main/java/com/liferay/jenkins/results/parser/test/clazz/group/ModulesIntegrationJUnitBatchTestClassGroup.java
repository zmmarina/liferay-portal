 ...
 */
public class ModulesIntegrationJUnitBatchTestClassGroup
	extends ModulesJUnitBatchTestClassGroup {

	protected ModulesIntegrationJUnitBatchTestClassGroup(
	...
	protected boolean isValidTestClass(TestClass testClass) {
		...
		try {
			...
			if (testClassFilePath.contains("/src/testIntegration/")) {
				return true;
			}
		}
