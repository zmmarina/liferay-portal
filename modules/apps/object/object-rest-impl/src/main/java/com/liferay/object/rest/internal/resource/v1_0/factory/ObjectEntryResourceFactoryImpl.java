...
package com.liferay.object.rest.internal.resource.v1_0.factory;
 ...
 * @generated
 */
@Component(immediate = true, service = ObjectEntryResource.Factory.class)
@Generated("")
public class ObjectEntryResourceFactoryImpl
	...
	public ObjectEntryResource.Builder create() {
		return new ObjectEntryResource.Builder() {
			...
			public ObjectEntryResource build() {
				...
				return (ObjectEntryResource)ProxyUtil.newProxyInstance(
					ObjectEntryResource.class.getClassLoader(),
					new Class<?>[] {ObjectEntryResource.class},
	...
	protected void activate() {
		ObjectEntryResource.FactoryHolder.factory = this;
	}

	@Deactivate
	protected void deactivate() {
		ObjectEntryResource.FactoryHolder.factory = null;
	}
	...
	private Object _invoke(
		...
		objectEntryResource.setContextCompany(company);

		objectEntryResource.setContextHttpServletRequest(httpServletRequest);
		objectEntryResource.setContextUser(user);

		try {
			return method.invoke(objectEntryResource, arguments);
		}
		catch (InvocationTargetException invocationTargetException) {
			throw invocationTargetException.getTargetException();
		}
		finally {
			_componentServiceObjects.ungetService(objectEntryResource);
