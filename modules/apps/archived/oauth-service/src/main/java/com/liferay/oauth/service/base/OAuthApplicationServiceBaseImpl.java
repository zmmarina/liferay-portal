...
public abstract class OAuthApplicationServiceBaseImpl
	...
	implements AopService, IdentifiableOSGiService, OAuthApplicationService {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			OAuthApplicationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		oAuthApplicationService = (OAuthApplicationService)aopProxy;
