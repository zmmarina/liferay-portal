...
public class CryptoHashGeneratorTest {
	...
	public void setUp() throws Exception {
		...
		_cryptoHashVerifier =
			cryptoHashVerifierRegistry.getCryptoHashVerifier();
	}
