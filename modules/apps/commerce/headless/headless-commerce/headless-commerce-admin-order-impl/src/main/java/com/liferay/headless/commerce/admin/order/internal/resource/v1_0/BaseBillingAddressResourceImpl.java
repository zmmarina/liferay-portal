...
public abstract class BaseBillingAddressResourceImpl
	implements BillingAddressResource, EntityModelResource,
			   VulcanBatchEngineTaskItemDelegate<BillingAddress> {
	...
	public void create(
			java.util.Collection<BillingAddress> billingAddresses,
