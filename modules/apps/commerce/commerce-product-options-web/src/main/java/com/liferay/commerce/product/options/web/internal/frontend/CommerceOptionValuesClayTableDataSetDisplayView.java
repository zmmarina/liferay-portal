...
@Component(
	...
	property = "clay.data.set.display.name=" + CommerceOptionDataSetConstants.COMMERCE_DATA_SET_KEY_OPTION_VALUES,
	service = ClayDataSetDisplayView.class
)
public class CommerceOptionValuesClayTableDataSetDisplayView
