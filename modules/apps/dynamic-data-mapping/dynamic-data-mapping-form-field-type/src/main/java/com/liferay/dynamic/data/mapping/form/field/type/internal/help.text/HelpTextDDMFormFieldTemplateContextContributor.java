...
@Component(
	immediate = true,
	property = "ddm.form.field.type.name=" + DDMFormFieldTypeConstants.HELP_TEXT,
	service = {
		DDMFormFieldTemplateContextContributor.class,
		HelpTextDDMFormFieldTemplateContextContributor.class
	}
)
public class HelpTextDDMFormFieldTemplateContextContributor
