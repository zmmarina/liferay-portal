...
@Meta.OCD(
	...
	localization = "content/Language", name = "azure-blob-storage-store-configuration-name"
)
public interface AzureBlobStorageStoreConfiguration {
	...
	@Meta.AD(
		description = "connection-string-help", name = "connection-string", required = true
	)
	 ...
	 */
	@Meta.AD(
		description = "container-name-help", name = "container-name", required = true
	)
	 ...
	 */
	@Meta.AD(
		description = "encryption-scope-help", name = "encryption-scope", required = false
	)
	String encryptionScope();

	@Meta.AD(
		description = "http-logging-enabled-help", name = "http-logging-enabled", required = false
	)
